...
const PizzaDetails = ({ pizza }) => {
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-x-8 h-full md:p-8">
            {/* top */}
            ...
            <div className="flex flex-col flex-1 px-10">
                <div className="flex-1 p-2 text-center lg:text-left">
                    <div className="flex-1 bg-white overflow-y-scroll h-[46vh] scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-white pr-2">
                        ...
                        {/* topping list */}
                        <div className="flex flex-1 flex-wrap gap-3 py-1 justify-center lg:justify-start">
